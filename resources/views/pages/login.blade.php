  ...
  <div class="max-w-md w-full space-y-8">
    ...
    <div class="rounded-md shadow-sm -space-y-px mb-5">
      <div>
        ...
        {{Form::text('email', '', ['class' => 'appearance-none rounded-none relative block w-full px-3 py-2 border
        border-gray-300 placeholder-gray-500 text-gray-900
        rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10
        sm:text-sm','placeholder'=>'Email address'])}}
        <span class="text-red-500">@error('email'){{ $message }} @enderror
      </div>
      <div>
        {{Form::label('password', 'Password',['class'=>'sr-only'])}}
        {{Form::text('password', '', ['class' => 'appearance-none rounded-none relative block w-full px-3 py-2 border
        border-gray-300 placeholder-gray-500 text-gray-900
        rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10
